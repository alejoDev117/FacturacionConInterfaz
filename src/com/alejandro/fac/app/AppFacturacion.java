                ...
                case 0: {
                    ...
                    switch (opcionFactura) {
                        ...
                        case 3: {
                            ...
                            int diaVence = Integer.parseInt((String) JOptionPane.showInputDialog(null,"Ingrese Dia de vencimiento","Recuerde Fecha Actual: "+sistemaFacturacion.getFacturaVencidaCasoParticular().getFecha(),JOptionPane.INFORMATION_MESSAGE,iconoCalendario,sistemaFacturacion.topeNumeroDias(mesVence).toArray(),null));
